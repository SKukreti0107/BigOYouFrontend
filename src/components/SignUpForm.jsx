...
export default function SignUpForm() {
    ...
    const signUp = async ({ username, email, password }) => {
        try {
            ...
            setError(err.response?.data?.detail ? new Error(err.response.data.detail) : err);
        } finally {
            setLoading(false);
        }
    }
        ...
        <form className="space-y-5" onSubmit={formik.handleSubmit}>
            <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                    ...
                    <input
                        ...
                        placeholder="Alex Rivera" name="username"
                        type="text" onChange={formik.handleChange} value={formik.values.username}
                    />
                    {formik.errors.username ? <div style={{ color: "red", fontSize: "0.875rem", marginTop: "0.25rem" }}>{formik.errors.username}</div> : null}
                </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                    ...
                    />
                    {formik.errors.email ? <div style={{ color: "red", fontSize: "0.875rem", marginTop: "0.25rem" }}>{formik.errors.email}</div> : null}
                </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                    ...
                    />
                    {formik.errors.password ? <div style={{ color: "red", fontSize: "0.875rem", marginTop: "0.25rem" }}>{formik.errors.password}</div> : null}
                </div>
                ...
                <div className="relative group">
                    ...
                    />
                    {formik.errors.confirmPassword ? <div style={{ color: "red", fontSize: "0.875rem", marginTop: "0.25rem" }}>{formik.errors.confirmPassword}</div> : null}
                </div>
            </div>
